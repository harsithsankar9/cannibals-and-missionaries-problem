...
class State():
    ...
    def __eq__(self, other):
        return (self.left[0] == other.left[0] and self.left[1] == other.left[1]
                and self.right[0] == other.right[0] and self.right[1] == other.right[1] and
...
def main():
    ...
    for state in path:
        if state.boat:
            print("""{:3} | b| {:3}\n{:3} | |
{:3}""".format("c"*state.left[1], "c"*state.right[1], "m"*state.left[0],
                   "m"*state.right[0]))
        else:
            print("""{:3} |b | {:3}\n{:3} | |
{:3}""".format("c"*state.left[1], "c"*state.right[1], "m"*state.left[0],
